...
query <- dbGetQuery(mg1, 'pickdata', "{'salinity': {'$gte': 0}, 'date_time': {'$gte': 0}}")
utilities <- query[c('salinity', 'date_time')]
summary(utilities)

#utilities <- read.csv("C:/Users/Jay/Desktop/salinitydata.csv")
# plot the graph
plot(salinity ~ date_time, utilities)
